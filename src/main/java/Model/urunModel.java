...
public class urunModel {
	...
	public urunModel(String urunAdi, String urunDetay, int urunFiyat, int urunAdet, String fotograf, String ozelKategori,
			String kategoriKodu) {
		super();
		this.urunAdi = urunAdi;
	...
	public urunModel(int urunKodu, String urunAdi, String urunDetay, int urunFiyat, int urunAdet, String fotograf,
			String ozelKategori, String kategoriKodu) {
	...
	public String getOzelKategori() {
		return ozelKategori;
	}
	public void setOzelKategori(String ozelKategori) {
		this.ozelKategori = ozelKategori;
	}
