				...
				<div class="row">
					...
					<div class="col-sm-3">
						<div class="search_box pull-right">
							<input type="text" placeholder="MTM Market'de Ara"/>
						</div>
					</div>
				</div>
			</div>
					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-6">
									<h1><span>MTM</span>-MARKET</h1>
									<h2>Sebze,Meyve Urunlerinde %15 Indirim Firsatini Kacirmayin!</h2>
									<p>Secili Sebze ve Meyve urunlerinde %15 indirim. </p>
									<button type="button" class="btn btn-default get">Simdi Al</button>
								</div>
								<div class="col-sm-6">
									<img src="images/home/sebze.jpg" class="girl img-responsive" alt="" />
							...
							<div class="item">
								<div class="col-sm-6">
									<h1><span>MTM</span>-MARKET</h1>
									<h2>Sut Ve Kahvaltiliklarda %15 Indirim.</h2>
									<p> Tum sut ve kahvaltiliklarda %15 indirim. </p>
									<button type="button" class="btn btn-default get">Simdi Al</button>
								</div>
								<div class="col-sm-6">
									<img src="images/home/sutler.png" class="girl img-responsive" alt="" />
							...
							<div class="item">
								<div class="col-sm-6">
									<h1><span>MTM</span>-MARKET</h1>
									<h2>Deterjan,Temizlik Urunlerinde %10 Indirim.</h2>
									<p>Secili Deterjan ve Temizlik urunlerinde %10 indirim. </p>
									<button type="button" class="btn btn-default get">Simdi Al</button>
								</div>
								<div class="col-sm-6">
									<img src="images/home/mel1.jpg" class="girl img-responsive" alt="" />
				...
				<div class="col-sm-3">
					<div class="left-sidebar">
						...
						<div class="shipping text-center"><!--shipping-->
							<img src="images/home/slogan.png" alt="" />
						</div><!--/shipping-->
                            ...
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center">
                                        ...
                                        <p><%= urun.getUrunAdi() %></p>
                                        <a href="addCart.jsp" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Sepete Ekle</a>
                                    </div>
                                    <div class="product-overlay">
                                        <div class="overlay-content">
                                            <h2><%= urun.getUrunFiyat() %> TL</h2>
                                            <p><%= urun.getUrunAdi() %></p>
                                            <input type="hidden" id="product" name="product" value=<% urun.getUrunKodu(); %>>
                                            <input type="hidden" id="price" name="price" value=<% urun.getUrunFiyat(); %>>
                                            <input type="hidden" id="name" name="name" value=<% urun.getUrunAdi(); %>>
                                            <input type="hidden" id="urunFotograf" name= "urunFotograf" value=<% urun.getFotograf(); %>>
                                            <a href="index.jsp?urunKodu=<%=urun.getUrunKodu()%>&urunFotograf=<%=urun.getFotograf()%>&urunAdi=<%=urun.getUrunAdi()%>&urunFiyati=<%=urun.getUrunFiyat()%>"  class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Sepete Ekle</a>
                                            </div>
                                    </div>
                                </div>
                            </div>
...
%>
					...
					<div class="recommended_items"><!--recommended_items-->
						<h2 class="title text-center">En Cok Satan Urunler</h2>
								...
								<div class="item active">	
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src="images/home/sut1.jpg" alt="" />
													<h2>7,50 TL</h2>
													<p>Sütaş Laktozsuz Süt</p>
									...
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src="images/home/makar.jpeg" alt="" />
													<h2>4,25 TL</h2>
													<p>Ankara Makarna</p>
													<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Sepete Ekle</a>
												</div>
									...
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src="images/home/sampuan.jpeg" alt="" />
													<h2>19,95 TL</h2>
													<p>Loreal Elseve Şampuan</p>
													<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Sepete Ekle</a>
												</div>
